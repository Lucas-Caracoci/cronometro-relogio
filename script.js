...
var wpp = [
    'videos/samurai-in-the-autumn-forest-HD-live-wallpaper.mp4',
    'videos/megumi-fushiguro-jujutsu-kaisen-4k-live-wallpaper.mp4',
    'videos/mudkip-rainy-day-pond-pokemon-HD-live.mp4',
    'videos/hashira-giyu-tomioka-katana-water-4k-live-wallpaper.mp4',
    'videos/fumasa.mp4'
]
var wpp1 = wpp.length
...
function setButtonBackgroundColor() {
    ...
    } else if (vid.src.includes('mudkip-rainy-day-pond-pokemon-HD-live.mp4')) {
        applyThemeToButtons('btn4');
    } else if (vid.src.includes('hashira-giyu-tomioka-katana-water-4k-live-wallpaper.mp4')) {
        applyThemeToButtons('btn3');
    } else if (vid.src.includes('videos/fumasa.mp4')) {
